            ...
            <div>
              ...
              {project.repoLink && (
                <span className="text-zinc-200">
                  🔗 Learn more about the project's development at the following link:{" "}
                  <a href={project.repoLink} target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">
                    {project.repoLink}
                  </a>
                </span>
              )}
